            ...
            success:function(r) {
                ...
                if(total_suffix == d.total_suffix_docking){
                    ...
                    swal.fire({
                        ...
                        html:'Sistem berhasil docking <b>'+total_docking+ '</b> data, sesuai planning<br>Silahkan klik Heijunka di bawah ini<br>'+buttonHeijunka+'<a href="javascript:void(0)" onclick="swal_close()" class="btn btn-secondary mt-4 ml-2">Tetap Disini</a>',
                        showConfirmButton: false,
                    });
					if(tipe == "kap1"){
						$("#docking-kap1").html("Docking");
					}else{
