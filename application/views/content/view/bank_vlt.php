<style>
    ...
    /* ── Excel-like dropdown filter (header) ── */
    .dt-dropdown { position: relative; display: block; }
    .dt-dd-btn {
        width: 100%; font-size: .68rem; padding: 3px 6px;
        border: 1px solid #ced4da; border-radius: 3px;
        background: #fff; cursor: pointer;
        display: flex; align-items: center; justify-content: space-between; gap: 4px;
        white-space: nowrap; line-height: 1.4; color: #333;
    }
    ...
    .dt-dd-panel {
        ...
        font-size: .72rem; text-align: left; cursor: default;
    }
    /* override aturan lama .filter-row th input agar checkbox dropdown tidak melebar */
    .dt-dd-panel input[type=checkbox] {
        width: auto !important; min-width: 0 !important;
        flex: 0 0 auto; margin: 0;
    }
    .dt-dd-search { margin-bottom: 6px; }
    .dt-dd-search input { font-size: .7rem !important; width: 100%; }
    .dt-dd-select-all {
    ...
    .dt-dd-item span { flex: 1 1 auto; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .dt-dd-footer {
        display: flex; gap: 5px; justify-content: flex-end;
        border-top: 1px solid #dee2e6; padding-top: 6px;
    }
    .dt-dd-footer .btn { font-size: .68rem; padding: 2px 10px; }
...
<div class="container-fluid mt-3 pl-3 pr-3">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body p-3">
            ...
            <!-- Page length -->
            <div class="d-flex align-items-center mb-2" style="gap:6px; font-size:.8rem;">
                <span>Tampilkan</span>
                <select id="page-size" class="form-control form-control-sm" style="width:75px;" onchange="changePageSize(this.value)">
                        ...
                        <tr class="filter-row" id="filter-row">
                            ...
                            <th>
                                <div class="dt-dropdown">
                                    <button class="dt-dd-btn" id="dd-btn-<?= $c ?>" type="button" onclick="toggleDropdown(event,<?= $c ?>)">Semua <i class="fas fa-chevron-down fa-xs"></i></button>
                                    <div class="dt-dd-panel" id="dd-panel-<?= $c ?>" style="display:none;"></div>
                                </div>
                            </th>
                            <?php endfor; ?>
                            <th></th>
            ...
            <div class="mt-2 d-flex flex-wrap align-items-center justify-content-between" style="gap:10px;">
                <span class="data-counter font-weight-bold" style="font-size:.8rem;">
                    Menampilkan <span id="page-info" class="text-primary">0</span>
                    dari <span id="cnt-shown" class="text-primary">0</span> data
                    <span class="text-muted">(total <span id="cnt-total">0</span>)</span>
                </span>
                <nav><ul class="pagination pagination-sm mb-0" id="bvlt-pagination"></ul></nav>
            </div>
        </div>
    </div>
</div>
