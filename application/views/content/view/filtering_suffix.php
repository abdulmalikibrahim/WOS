            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 mb-3">
                        <form action="<?= base_url("filtering_suffix/add?p=kap1") ?>" method="post">
                            <p class="mb-1">Input Suffix</p>
                            ...
                            foreach ($dataKap1 as $dataKap1) {
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <a href="<?= base_url("filtering_suffix/delete?i=".$dataKap1->id); ?>" class="btn btn-danger" title="Hapus" ><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php
                            }
    ...
    <div class="col-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 mb-3">
                        <form action="<?= base_url("filtering_suffix/add?p=kap2") ?>" method="post">
                            <p class="mb-1">Input Suffix</p>
                            <div class="input-group">
                                <input type="text" name="color" class="form-control" placeholder="Masukkan color disini">
                                <button class="button btn btn-info"><i class="fas fa-save mr-1"></i>Simpan</button>
                        ...
                        if(!empty($dataKap2)){
                            ...
                            foreach ($dataKap2 as $dataKap2) {
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <a href="<?= base_url("filtering_suffix/delete?i=".$dataKap2->id); ?>" class="btn btn-danger" title="Hapus" ><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php
                            }
